...
class MLPBCModel(TrajectoryModel):
    ...
    def __init__(self, state_dim, act_dim, hidden_size, n_layer,
                    action_tanh=False, dropout=0.1, max_length=1, **kwargs):
        ...
        self.model = nn.Sequential(*(layers+ ([nn.Tanh()] if action_tanh else [])))
